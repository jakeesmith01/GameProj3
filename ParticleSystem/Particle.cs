...
namespace ParticleSystem
{
    ...
    public struct Particle
    {
        ...
        /// <summary>
        /// If the particle is collided with, it is 'dead' 
        /// </summary>
        public bool DeadParticle;

        /// <summary>
        /// The (optional) hitbox for the particle
        /// </summary>
        ...
        /// Sets the particle up for first use 
        /// </summary>
        public void Initialize(Vector2 position, Vector2 velocity, Vector2 acceleration, Color color, BoundingCircle hitbox, float lifetime = 1, float scale = 1, float rotation = 0, float angularVelocity = 0, float angularAcceleration = 0)
        {
            this.Position = position;
            this.Velocity = velocity;
            this.Acceleration = acceleration;
