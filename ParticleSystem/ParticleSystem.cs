...
namespace ParticleSystem
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        /// <summary>
        /// The ScreenManager for the game
        /// </summary>
        ...
        /// <summary>
        /// The collection of particles (made public to allow for collision checking in child classes)
        /// </summary>
        ...
        /// <summary>
        /// The texture this particle system uses (made public for use within ExplosionParticleSystem) 
        /// </summary>
        public Texture2D texture;

        /// <summary>
        /// The origin when we're drawing textures (made public for use within ExplosionParticleSystem)
        /// </summary>
        ...
        public ParticleSystem(ScreenManager screen, int maxParticles) : base(screen.Game) 
        {
        ...
        {
            if(p.Position == Vector2.Zero) return;
        ...
        protected override void LoadContent()
        {
            ...
            if (spriteBatch == null) spriteBatch = _screenManager.SpriteBatch;
        ...
        public virtual void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            // if we're using additive blending, we want to end the sprite batch
            // and then start a new one, so we can use the additive blend mode.
